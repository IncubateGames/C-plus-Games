...
void Gravity::Apply(ParticleSystem &ps,const float& dt){
	unsigned  cont=0;
...
void Fade::Apply(ParticleSystem &ps,const float& dt){
	unsigned  cont=0;
	ParticleSystem::Particle *p=ps.particles;
	while(cont<ps.nMaxParticles){
...
void ScreenCollision::Apply(ParticleSystem &ps,const float& dt){
	unsigned  cont=0;
	ParticleSystem::Particle *p=ps.particles;
...
void SeekerGonzalo::Apply(ParticleSystem &ps,const float& dt){
	unsigned  cont=0;
