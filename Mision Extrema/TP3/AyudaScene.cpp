...
{
	spriteIntro.SetImage(TextureManager::GetInstance().GetTexture("../data/images/Intro1.png"));	
}
...
{	
	...
	{
		spriteIntro.SetImage(TextureManager::GetInstance().GetTexture("../data/images/Mision.png"));				
	}
	else if(contador > 22)
	{
		isFinished = true;
